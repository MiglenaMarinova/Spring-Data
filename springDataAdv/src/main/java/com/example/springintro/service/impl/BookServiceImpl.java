...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public List<String> findAllBooksWithLessThan5000Copies() {
       return bookRepository
    ...
    @Override
    public List<String> findAllBookWithPriceLessThan4And40() {
        return bookRepository
    ...
    @Override
    public List<String> findAllBookNotReleasedInYear(int year) {
    ...
    @Override
    public List<String> findAllBookTheirTitleContainingString(String givenString) {

        return bookRepository
                .findBooksByTitleContains(givenString)
                .stream()
                .map(Book::getTitle)
                .collect(Collectors.toList());
    }
    ...
    @Override
    public List<String> findAllBookTitleFromAuthorWhichLastNameStartsWithStr(String startStr) {
        return bookRepository
                .findBooksByAuthor_LastNameStartingWith(startStr)
                .stream()
    ...
    @Override
    public int findAllBookWithTitleLengthMoreThan(int titleLength) {
        return bookRepository.countBookByTitleGreaterThan(titleLength);
    }
